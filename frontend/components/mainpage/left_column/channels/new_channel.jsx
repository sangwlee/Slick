...
class NewChannel extends React.Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    // const channelData = Object.assign({}, this.state({name, description, kind}));
    let new_channel;
    ...
    this.state.members.forEach( member => {
      this.props.createSubscription(member.id, new_channel.id);
    });

    this.props.createSubscription( this.props.currentUser.id, new_channel.id);
    this.props.closeModal();
    this.props.history.push(`/main/${new_channel.id}`);
  }
